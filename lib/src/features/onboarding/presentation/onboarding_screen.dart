...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  void _navigateToAuth() {
    debugPrint('Onboarding: Navigate to Auth clicked.');
                      ...
                      children: [
                         SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              debugPrint('Onboarding: Hire a Professional clicked. Navigating to MainScreen(isGuest: true)');
                              // Hire a Professional -> Guest Mode (MainScreen)
                              Navigator.of(context).pushReplacement(
                            ...
                            child: const Text('Hire a Professional', style: TextStyle(fontSize: 16)),
                          ),
                        ),
